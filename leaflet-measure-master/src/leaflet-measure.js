! function(e) {
    ...
    L.Control.Measure = L.Control.extend({
        ...
        _getMeasurementDisplayStrings: function(e) {
            ...
            function r(e, t, r, n) {
                var o = { acres: "Acres", feet: "Feet", kilometers: "Kilometros", hectares: "Hectareas", meters: "Metros", miles: "Miles", sqfeet: "Sq Feet", sqmeters: "Metros cuadrados", sqmiles: "Sq Miles" },
...
}, function(e, t, r) { e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="Measure distances and areas">M</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Medir distancias y areas</h3> <ul class=tasks> <a href=# class="js-start start">Crear una nueva medicion</a> </ul> </div> <div class=js-measuringprompt> <h3>Medir distancias y áreas.</h3> <p class=js-starthelp>Comience a crear una medición agregando puntos al mapa</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancelar</a></li> <li><a href=# class="js-finish finish">Finalizar medición</a></li> </ul> </div> </div> ' }, function(e, t, r) { e.exports = '<div class=group> <p class="lastpoint heading">Ultimo punto</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Distancia del camino</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Area</span> {{ model.areaDisplay }}</p> </div> <% } %> ' }, function(e, t, r) { e.exports = '<h3>Point location</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centro figura</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> ' }, function(e, t, r) { e.exports = '<h3>Medición lineal</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this line</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Borrar</a></li> </ul> ' }, function(e, t, r) { e.exports = '<h3>Area medida</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perimetro</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centro de figura</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> ' }]);